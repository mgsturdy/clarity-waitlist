        ...
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="max-w-lg mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-black text-white py-5 px-8 font-body text-lg font-medium hover:bg-black/80 transition-colors mt-6"
              >
                → Join Waitlist — Priority Access + Lowest Rates
              </button>
            </form>
